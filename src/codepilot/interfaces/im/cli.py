...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Codepilot IM bridge service")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    events_dir = Path(args.events_dir) if args.events_dir else Path(args.workspace) / ".codepilot" / "im" / "events"
